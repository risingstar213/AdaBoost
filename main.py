...
for i in range(10):
    ...
    sub_X2 = X[386 * (1 + i):]
    sub_Y2 = Y[386 * (1 + i):]
    train_X = np.r_[sub_X1, sub_X2]
    train_Y = np.r_[sub_Y1, sub_Y2]
    test_X = X[368 * i:368 * (i + 1)]
    model = AdaBoost(1, "DecisionTree")
